<!-- ↓bookfair_functionlphpの読み込み -->
<?php get_bookfair_function(); ?>
    ...
    <div id="insert_bookfair_info_area">
        ...
        <span>開始時間（12:30以外ならクリックして選択）：</span></br>
        <input type="text" value="12:30" id="start_bookfair_time" class="bookfair_day"/></br>
        <span>終了時間（13:30以外ならクリックして選択）：</span></br>
        <input type="text" value="13:30" id="end_bookfair_time" class="bookfair_day"/></br>
